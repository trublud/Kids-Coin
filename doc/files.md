...
* kidscoin.conf: contains configuration settings for kidscoind or kidscoin-qt
* kidscoind.pid: stores the process id of kidscoind while running
...
* debug.log: contains debug information and general logging generated by kidscoind or kidscoin-qt
