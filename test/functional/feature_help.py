...
"""Verify that starting kidscoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kidscoin with -h for help text")
        ...
        self.log.info("Start kidscoin with -version for version information")
