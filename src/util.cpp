...
const char * const BITCOIN_CONF_FILENAME = "kidscoin.conf";
const char * const BITCOIN_PID_FILENAME = "kidscoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KidsCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/KidsCoin";
#else
    // Unix
    return pathRet / ".kidscoin";
#endif
#endif
}
