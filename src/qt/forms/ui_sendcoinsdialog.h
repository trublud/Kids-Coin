...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 KDC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 KDC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 KDC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 KDC"));
        ...
        labelBalance->setText(QStringLiteral("123.456 KDC"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for kidscoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for kidscoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
