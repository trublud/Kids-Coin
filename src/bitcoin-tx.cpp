...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kidscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kidscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kidscoin transaction") + "\n" +
              "  kidscoin-tx [options] -create [commands]   " + _("Create hex-encoded kidscoin transaction") + "\n" +
              "\n";
